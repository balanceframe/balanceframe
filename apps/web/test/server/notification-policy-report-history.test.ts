...
const SAMPLE_POLICY = { id: 'pol_001', spaceId: 'space_1', policyKey: 'delivery', policyVersion: 'v1', policy: '{}', isActive: true, createdAt: '2026-07-27T10:00:00Z', updatedAt: '2026-07-27T10:00:00Z' };
...
describe('POST /api/notifications/policy', () => {
  ...
  it('must save notification policy', async () => {
    mockReadBody.mockResolvedValue({ spaceId: 'space_1', policyKey: 'delivery', policyVersion: 'v1', policy: { maxRetries: 3 } });
...
describe('GET /api/reports/history', () => {
  ...
  it('must return report history', async () => {
    mockStore.getReportHistory.mockResolvedValue([{ id: 'r_001', reportType: 'spending', label: 'July Spending', isExpired: false }]);
